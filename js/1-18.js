...
makeTransaction(1000, 3, 15000); // возвращает 'Вы купили 3 дроидов, на счету осталось 12000 кредитов'.
makeTransaction(5000, 10, 8000); // возвращает 'Недостаточно средств на счету!'.
makeTransaction(2000, 8, 10000); // возвращает 'Недостаточно средств на счету!'.
makeTransaction(500, 10, 5000); // возвращает 'Вы купили 10 дроидов, на счету осталось 0 кредитов'
